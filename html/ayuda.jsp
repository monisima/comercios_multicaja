...
<div class="collapse txt-ayuda" id="preg1">        
    ...
    <div class="collapse txt-ayuda" id="preg2">
      <p class="bullet">Se abonan dentro de los 5 primeros días hábiles del mes. Revisa el calendario de pagos <a href="https://www.multicaja.cl/comercios/noticias/calendario-comisiones-2016.jsp" class="rojo" target="_blank"> aquí [+].</a></p>
      <p class="bullet">Las comisiones pagadas por Multicaja, o los descuentos por tarifa, son realizados en tu saldo Multicaja.</p>
      <p class="bullet">Las comisiones pagadas por Multicaja, o los descuentos por tarifa, </p>
      <p class="bullet">Puedes solicitar que el pago de tus comisiones sea transferido a una cuenta bancaria. El Rut del titular de la cuenta bancaria debe ser el mismo que el titular en Multicaja. No se transferirá a cuentas de terceros.</p>
      <p class="bullet">Las comisiones pagadas por Multicaja, o los descuentos por tarifa, </p>
      <p class="bullet">Todos los meses recibirás un resumen de tus comisiones en tu correo electrónico. Mantén tu correo actualizado en nuestro sitio web Comercios, ingresando con tu RUT y clave a la sección Mis Datos.</p>
      <p class="bullet">Las comisiones pagadas por Multicaja, o los descuentos por tarifa, </p></p>
    </div>
...
<h3>Saldo Multicaja</h3>
    ...
    <div class="collapse txt-ayuda" id="preg3">
        <p class="bullet">Entrega giros bancarios en efectivo y tu Saldo Multicaja aumentará en línea. Puedes entregar hasta $100.000 en efectivo al día a cada tarjeta habiente de los bancos Bci, Bci Nova, Tbanc, Santander y Banefe. </p>
        <p class="bullet">Transfiere por Internet o deposita siempre con los 4 últimos dígitos de tu número de terminal. Si tu Nº de terminal es 1001234, debes depositar $141.234, $151.234, etc. No podrás depositar el mismo monto más de una vez al día. </p>
...
<div class="collapse txt-ayuda" id="preg4"> 
      ...
      <p class="bullet"><strong> Pago de cuentas:</strong> Existen más de 190 empresas adheridas que tus clientes pueden pagar en tu negocio. Revisa convenios disponibles en <a href="https://www.multicaja.cl/comercios/documento/Pago_cuentas_pos.pdf" target="_blank" class="rojo">POS</a> y <a href="https://www.multicaja.cl/comercios/documento/Pago_cuentas_web.pdf"target="_blank" class="rojo">WEB.</a></p></li>

      <p class="bullet"><strong> Giros:</strong> Entrega giros en efectivo a tus clientes que tengan tarjetas de los bancos Bci, Bci Nova, Tbanc, Santander y Banefe. Los montos permitidos son hasta los $100.000 diarios por tarjeta habiente. La comisión de este servicio es de $100 para los giros con banco Santander y Santander Banefe y 0,00255 UF + IVA para los bancos Bci, Bci Nova y Tbanc.</p></li>

      <p class="bullet"><strong>  Depósitos:</strong> Recibe depósitos de tus clientes que tengan tarjetas de los bancos asociados. Los montos permitidos son hasta los $150.000 diarios para banco Bci, Bci Nova, Tbanc y $400.000 diarios para banco Santander y Banefe, por tarjeta habiente. La comisión de este servicio es de 0,00255 UF + IVA.<</p></li>

      <p class="bullet"><strong> Pago crédito consumo e hipotecario:</strong> Ofrece a tus clientes la opción de pagar sus cuotas de créditos que tengan en los bancos asociados. Clientes Bci sólo pueden pagar créditos de consumo. La comisión de este servicio es de 0,00255 UF + IVA. </p></li>

      <p class="bullet"><strong> Pago tarjeta de crédito:</strong> Ofrece a tus clientes la opción de pagar su tarjeta de crédito Santander. La comisión de este servicio es de 0,00255 UF + IVA.</p></li>
...
<div class="collapse txt-ayuda" id="preg5">        
          ...
          <p class="bullet">Tus clientes tendrán la opción de pagar sus cuentas con efectivo o con su tarjeta de débito Santander y Banefe, siempre y cuando los servicios bancarios estén habilitados en el equipo POS. Ten en cuenta que no necesitas tener saldo Multicaja disponible en caso que tus clientes paguen con su tarjeta de débito bancaria Santander y Banefe.</p></li>

            <p class="bullet">Si el pago es realizado a través de un terminal web, sólo está permitido el efectivo.</p></li>
</div>
...
<div class="collapse txt-ayuda" id="preg8">       
      ...
      <p class="bullet">Si olvidaste tu clave, puedes recuperarla ingresando tu RUT <a href="https://www.multicaja.cl/comercio/recuperarClavePaso1" class="rojo" target="_blank">aquí.</a> La nueva clave será enviada al correo electrónico y celular registrados en Multicaja, minutos después de realizada la solicitud. </p>
      <p class="bullet">Si ingresas incorrectamente tu clave más de 3 veces, ésta será bloqueada y deberás solicitar una nueva.</p>
</div>
...
<div class="collapse txt-ayuda" id="preg11">      
           ...
           <p>Te haremos entrega de publicidad gratuita apenas comiences a trabajar con Multicaja. Este kit inicial consiste en material POP básico de recargas (mini pendón y colgante de recargas). </p>
             ...
             <p class="bullet">Debes mantener  ventas mensuales en recargas superiores a $500.000.</p>
             <p class="bullet">1 mes de antigüedad como comercio.</p>
             ...
             <p class="bullet">Debes mantener ventas mensuales en recargas superiores a $500.000.</p>
             <p class="bullet">Debes realizar mensualmente sobre 20 pagos de cuentas o servicios bancarios. </p>
             <p class="bullet">1 mes de antigüedad como comercio.</p>
</div>
...
<div class="collapse txt-ayuda" id="preg12">      
          <p class="bullet">Confirmar una recarga: </p>
            ...
            <p class="bullet"><strong>Consulta de saldo:</strong> Desde el menú principal, digita 6 >3 >1.</p>
            <p class="bullet"><strong>Consulta 5 últimas transacciones:</strong> Desde el menú principal, digita 6 > 3 > 3.</p>
            <p class="bullet"><strong>Consulta 5 últimos depósitos:</strong> Desde el menú principal, digita 6 >3 > 4.</p>
            <p class="bullet"><strong>Como solicitar rollos desde el Pos:</strong> Desde el Menú Principal, digita 6 > 7 > 1.</p>
            <p class="bullet"><strong>Reimprimir una transacción:</strong> Desde el menú principal, digita 6>3>2> Ingresa Código MC (el código MC aparece en la consulta de las 5 últimas transacciones y en el sitio web).</p>
</div>
...
<div class="collapse txt-ayuda" id="preg13">     
            <p class="bullet"><strong>Error GPRS:</strong> Error de señal que se puede producir por fallas en tu sector o del chip instalado en el equipo. Reinicia el equipo presionando simultáneamente la tecla amarilla > (•), o desenchufando el equipo por unos segundos.</p>
                <p class="bullet"><strong>Saldo insuficiente del comercio:</strong> No tienes saldo suficiente para realizar la transacción. Para solucionar esto, deberás entregar un giro bancario, realizar una transferencia o depósito en la cuenta del banco de Multicaja para aumentar tu saldo en el equipo POS.</p>
                <p class="bullet"><strong>Transacción No habilitada para terminal:</strong> Tu terminal no tiene activada esta transacción. Debes solicitar la habilitación a <a href="https://www.multicaja.cl/comercios/contacto_multicaja.jsp" class="rojo" target="_blank">contacto@multicaja.cl</a></p>
</div>
...
<div class="collapse txt-ayuda" id="preg14"> 
      ...
      <p class="bullet">Abc Din</p>
      <p class="bullet">Chilquinta</p>
      <p class="bullet">Corona</p>
      <p class="bullet">Cruz Verde</p>
      <p class="bullet">Hites</p>
      <p class="bullet">La Polar</p>
      <p class="bullet">Ripley (*)</p>
      <p class="bullet">CMR (*)</p>
...
<div class="collapse txt-ayuda" id="preg15">      
      ...
      <p class="bullet">La implementación del servicio se realizará en 10 días hábiles desde la entrega del contrato firmado y la documentación respectiva.</p>
      <p class="bullet">Instalación gratuita de adhesivos de cada tarjeta habilitada para que tus clientes identifiquen los medios de pago disponibles para comprar.</p>
</div>
...
<div class="collapse txt-ayuda" id="preg18">       
      ...
      <p class="bullet">Sólo permite anulaciones del mismo día.</p>
      <p class="bullet">Para anulaciones de ventas de días anteriores, se deberá dar aviso al emisor correspondiente, a los teléfonos incluidos en el reverso de la tarjeta.</p>
</div>
...
<div class="collapse txt-ayuda" id="preg20" >      
      ...
      <p class="bullet"><strong>Error de conexión: </strong>Reinicia el terminal. Si esto no funciona, desenchufa el equipo por 5 minutos y reintenta nuevamente la transacción. Si el problema continúa debes llamar a Call Center 600 363 20 20.</p>

      <p class="bullet"><strong>Error en lectura de tarjeta: </strong>Si el terminal arroja uno de los siguientes mensajes: "dirigirse a Hites", "cupo excede monto permitido" o "transacción rechazada” se debe a un rechazo comercial. Si el mensaje es otro o si el terminal no lee ninguna tarjeta,  debes comunicarte al Call Center 600 363 20 20. </p>
...
<p class="bullet"><strong> Edenred:</strong> <a href="http://www.ticketjunaeb.cl/" class="rojo" target="_blank">http://www.ticketjunaeb.cl.</a> </p>
<p class="bullet"><strong> Sodexo:</strong> <a href="http://www.becajunaebsodexo.cl/" class="rojo" target="_blank">http://www.becajunaebsodexo.cl/.</a></p>
...
<p class="bullet"><strong>Error 51 "Tarjeta sin Saldo":</strong> La tarjeta no posee dinero, debe ser recargada.</p>
<p class="bullet"><strong>Error 55 "Clave Incorrecta":</strong> Error en la clave ingresada por el cliente.</p>
<p class="bullet"><strong>Error A1 "Solicitar Habilitación en Edenred": </strong>Terminal no tiene habilitado este servicio. El comercio deberá contactarse con la empresa.</p>
<p class="bullet"><strong>Error 01 "Transacción No permitida, Solicitar Transacción en Edenred":</strong> El terminal no puede realizar esta transacción. El comercio deberá contactarse con la empresa.</p>
<p class="bullet"><strong>Error 03 "Solicitar Habilitación en Sodexo": </strong>Terminal no tiene habilitado este servicio. El comercio deberá contactarse con la empresa.</p>
<p class="bullet"><strong>Error 89 "Solicitar Habilitación en Multicaja": </strong>Terminal no se encuentra habilitado en Multicaja. El comercio deberá contactarse con nuestro Call Center al 600 363 20 20.</p>
</div>
...
<p class="bullet">Edenred: <a href="http://www.ticketjunaeb.cl/" target="_blank" class="rojo">http://www.ticketjunaeb.cl/</a></p>
<p class="bullet">Sodexo: <a href="http://www.becajunaebsodexo.cl/" target="_blank" class="rojo">http://www.becajunaebsodexo.cl/</a></p>
</div>
...
<p class="bullet"><strong> Sodexo:</strong> Cheque Restaurant Tarjeta y Beca Junaeb Sodexo.</p>
<p class="bullet"><strong> Edenred:</strong> Ticket Restaurant y Ticket Restaurant Junaeb.</p>                                           
 </div>
