...
<div id="inicio"></div>
	...
	<div class="container">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Corresponsal bancario</li>
			</ol>
		</div>
		</div>
		...
		<nav class="nav-fix navbar navbar-default menu-medio" data-spy="affix" data-offset-top="490">
		  <div class="container">
            ...
            <ul class="nav nav-tabs navbar-nav collapse-xs-menu nav-justified tab-num">
              ...
              <li class="acto"><a href="#sec1" class="tablinks"><div class="ico-bot-3"></div>Corresponsal Bancario</a><div class="lin-sep"></div></li>
...
<!--header-->
      	...
      	<div id="sec1" class="container-fluid">
      			...
      			<div class="row">
				      	  	<div class="container">
				      			<div class="titulo">
				      				<h2>Esta hoja es Corresponsal Bancario</h2>
				      				<p>Esta hoja es Corresponsal Bancario</p>
				      			</div>
				      				<div class='row'>
