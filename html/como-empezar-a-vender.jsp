      			...
      			<div class="row">
				      	  	<div class="container">
				      			<div class="enumerar-necesito-ser col-md-10 col-md-offset-1">
									...
									<p class="p-tooltip"><img src="images/num_03.jpg" class="num-cf">Recibirás tu clave al correo electrónico o al celular que registraste. La clave es imprescindible para operar con Multicaja.</p>
									...
									<p><img src="images/num_04.jpg" class="num-cf">Carga tu terminal.</p>	
									<p><img src="images/num_05.jpg" class="num-cf">Tu saldo se ajusta en minutos. ¡Ya puedes vender con Multicaja!.</p>	
