		...
		Verifica que esté bien escrita, si no aparece <a href="#" class="rojo">contáctanos</a> y dinos el convenio que necesitas para ver si lo podemos conseguir.
				      	  ...
				      	  <div class="col-md-8 col-md-offset-2 row">
								...
								<div class="row txt-bajada-tbl marg-txt-baja">										
											<p><img src="images/down.png" class="caret-como-fun">Recuerda que los montos mensuales de pago de cuentas suman para el <a href="https://www.multicaja.cl/comercios/ComisionesyTarifas.jsp" target="_blank">PREMIO MULTISERVICIO.</a></p>
