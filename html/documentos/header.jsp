          ...
          <div class="container">
           <div class="row">
	      	<nav role="navigation" class="navbar navbar-default menu-primero">
			        ...
			        <a href="../index.jsp" class="navbar-brand"><img src="../images/logo-MC-comercios.svg"  data-fallback-image="../images/logo-MC-comercios.png" class="logo-comercios"></a>
			        ...
			        <div id="navbarCollapse" class="collapse navbar-collapse navbar-primero-header">
			         <div class="row">   
				          ...
				          <div class="container">
					      	...
					      	<div class="row">
					      		 <a href="../index.jsp"><img src="../images/logo-MC-comercios.svg"  data-fallback-image="../images/logo-MC-comercios.png" class="logo-comercios"></a>
					      	</div>
					      	</div>
